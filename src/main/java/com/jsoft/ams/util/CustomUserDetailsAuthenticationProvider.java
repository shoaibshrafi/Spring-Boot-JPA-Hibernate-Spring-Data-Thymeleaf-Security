...
public class CustomUserDetailsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	*/
	...
	public CustomUserDetailsAuthenticationProvider(PasswordEncoder passwordEncoder, UserService userDetailsService) {
	...
	*/
	...
	throws AuthenticationException {
		...
		try {
			...
			TenantContextHolder.setTenantId(auth.getTenant());
